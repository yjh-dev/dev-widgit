...
export default function CreateBookmarkPage() {
  ...
  }, [url, title, desc, showIcon, showUrl, color, font, bg, transparentBg, borderRadius, padding, fontSize, fx, fxInt, gbg, gbgDir, neonColor, bshadow, tshadow, bw, bc, opacity, ls, entrance, entranceDelay]);
