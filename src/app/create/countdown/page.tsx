...
export default function CreateCountdownPage() {
  ...
  }, [minutes, seconds, showMs, autoRestart, accentColor, color, bg, transparentBg, borderRadius, padding, fontSize, fx, fxInt, gbg, gbgDir, neonColor, bshadow, tshadow, bw, bc, opacity, ls, entrance, entranceDelay]);
