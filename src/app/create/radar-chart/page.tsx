...
export default function CreateRadarChartPage() {
  ...
  }, [items, showValues, showGrid, gridLevels, fillOpacity, color, gridColor, textColor, bg, transparentBg, borderRadius, padding, fontSize, fx, fxInt, gbg, gbgDir, neonColor, bshadow, tshadow, bw, bc, opacity, ls, entrance, entranceDelay]);
