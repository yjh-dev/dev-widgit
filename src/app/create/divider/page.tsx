...
export default function CreateDividerPage() {
  ...
  }, [style, weight, color, color2, text, bg, transparentBg, borderRadius, padding, fontSize, fx, fxInt, gbg, gbgDir, neonColor, bshadow, tshadow, bw, bc, opacity, ls, entrance, entranceDelay]);
