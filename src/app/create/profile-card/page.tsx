...
export default function CreateProfileCardPage() {
  ...
  }, [name, bio, avatarUrl, layout, avatarShape, showBio, socials, accentColor, color, bg, transparentBg, borderRadius, padding, fontSize, fx, fxInt, gbg, gbgDir, neonColor, bshadow, tshadow, bw, bc, opacity, ls, entrance, entranceDelay]);
