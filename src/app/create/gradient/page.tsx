...
export default function CreateGradientPage() {
  ...
  }, [colors, dir, type, animate, speed, text, textColor, borderRadius, padding, fontSize, fx, fxInt, gbg, gbgDir, neonColor, bshadow, tshadow, bw, bc, opacity, ls, entrance, entranceDelay]);
