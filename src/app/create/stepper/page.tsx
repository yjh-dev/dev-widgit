...
export default function CreateStepperPage() {
  ...
  }, [steps, currentStep, layout, showDesc, showNumbers, color, completedColor, textColor, bg, transparentBg, borderRadius, padding, fontSize, fx, fxInt, gbg, gbgDir, neonColor, bshadow]);
