...
export default function CreateBreathingPage() {
  ...
  }, [technique, inhale, hold1, exhale, hold2, rounds, showGuide, accentColor, color, bg, transparentBg, borderRadius, padding, fontSize, fx, fxInt, gbg, gbgDir, neonColor, bshadow, tshadow, bw, bc, opacity, ls]);
