...
export default function CreateBannerPage() {
  ...
  }, [texts, animation, speed, align, bold, font, color, bg, transparentBg, borderRadius, padding, fontSize, fx, fxInt, gbg, gbgDir, neonColor, bshadow, tshadow, bw, bc, opacity, ls, entrance, entranceDelay]);
