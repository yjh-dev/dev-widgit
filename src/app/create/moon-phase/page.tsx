...
export default function CreateMoonPhasePage() {
  ...
  }, [style, showName, showPercent, showNext, moonColor, shadowColor, bg, transparentBg, textColor, moonSize, borderRadius, padding, fontSize, fx, fxInt, gbg, gbgDir, neonColor, bshadow, tshadow, bw, bc, opacity, ls, entrance, entranceDelay]);
