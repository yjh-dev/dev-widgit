...
export default function CreateMiniCalendarPage() {
  ...
  }, [weekStart, header, showDayNames, lang, showOtherDays, showNav, highlight, color, bg, transparentBg, borderRadius, padding, fontSize, fx, fxInt, gbg, gbgDir, neonColor, bshadow, tshadow, bw, bc, opacity, ls]);
