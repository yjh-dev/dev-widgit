...
export default function CreateTimetablePage() {
  ...
  }, [entries, startHour, endHour, lang, showGrid, color, bg, transparentBg, borderRadius, padding, fontSize, fx, fxInt, gbg, gbgDir, neonColor, bshadow, tshadow, bw, bc, opacity, ls]);
