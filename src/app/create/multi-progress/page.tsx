...
export default function CreateMultiProgressPage() {
  ...
  }, [items, showPercent, showValue, barHeight, layout, animated, textColor, bg, transparentBg, borderRadius, padding, fontSize, fx, fxInt, gbg, gbgDir, neonColor, bshadow, tshadow, bw, bc, opacity, ls]);
