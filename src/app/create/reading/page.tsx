...
export default function CreateReadingPage() {
  ...
  }, [title, currentPage, totalPages, style, showPages, color, textColor, font, bg, transparentBg, borderRadius, padding, fontSize, fx, fxInt, gbg, gbgDir, neonColor, bshadow]);
