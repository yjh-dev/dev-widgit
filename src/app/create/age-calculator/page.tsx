...
export default function CreateAgeCalculatorPage() {
  ...
  }, [birthdate, showTime, showLabel, style, color, textColor, bg, transparentBg, borderRadius, padding, fontSize, fx, fxInt, gbg, gbgDir, neonColor, bshadow, tshadow, bw, bc, opacity, ls]);
