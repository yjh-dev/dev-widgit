...
export default function CreateCounterPage() {
  ...
  }, [label, initial, step, min, max, showReset, color, btnColor, font, bg, transparentBg, borderRadius, padding, fontSize, fx, fxInt, gbg, gbgDir, neonColor, bshadow, tshadow, bw, bc, opacity, ls, entrance, entranceDelay]);
