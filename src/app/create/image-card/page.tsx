...
export default function CreateImageCardPage() {
  ...
  }, [imageUrl, caption, linkUrl, fit, captionPos, showCaption, color, bg, transparentBg, borderRadius, padding, fontSize, fx, fxInt, gbg, gbgDir, neonColor, bshadow, tshadow, bw, bc, opacity, ls]);
