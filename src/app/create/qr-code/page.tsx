...
export default function CreateQRCodePage() {
  ...
  }, [data, label, fgColor, bgColor, size, ec, moduleStyle, borderRadius, padding, fontSize, fx, fxInt, gbg, gbgDir, neonColor, bshadow, tshadow, bw, bc, opacity, ls, entrance, entranceDelay]);
