...
export default function CreatePasswordGenPage() {
  ...
  }, [length, upper, lower, numbers, symbols, color, textColor, font, bg, transparentBg, borderRadius, padding, fontSize, fx, fxInt, gbg, gbgDir, neonColor, bshadow, tshadow, bw, bc, opacity, ls, entrance, entranceDelay]);
