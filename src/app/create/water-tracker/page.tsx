...
export default function CreateWaterTrackerPage() {
  ...
  }, [goal, glassSize, color, showMl, textColor, bg, transparentBg, borderRadius, padding, fontSize, fx, fxInt, gbg, gbgDir, neonColor, bshadow, tshadow, bw, bc, opacity, ls, entrance, entranceDelay]);
