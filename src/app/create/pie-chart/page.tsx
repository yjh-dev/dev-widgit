...
export default function CreatePieChartPage() {
  ...
  }, [slices, style, showLabels, showPercent, showLegend, innerRadius, textColor, bg, transparentBg, borderRadius, padding, fontSize, fx, fxInt, gbg, gbgDir, neonColor, bshadow, tshadow, bw, bc, opacity, ls]);
