...
export default function CreateMiniGalleryPage() {
  ...
  }, [images, interval, transition, showDots, color, textColor, font, bg, transparentBg, borderRadius, padding, fontSize, fx, fxInt, gbg, gbgDir, neonColor, bshadow, tshadow, bw, bc, opacity, ls]);
