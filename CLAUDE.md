...
- **시간 & 날짜** (5): D-Day, 시계, 아날로그 시계, 미니 캘린더, 타임라인
- **진행률 & 목표** (4): 시간 진행률, 인생 달력, 읽기 진행률, 목표 진행률
- **생산성 & 도구** (4): 뽀모도로, 스톱워치, 카운터, 습관 트래커
- **콘텐츠 & 장식** (5): 명언 카드, 텍스트 배너, 북마크, 음악 플레이어, 날씨
